  ...
  return (
    <section className={s.container} id="skills">
      ...
      <p>
        ...
        mollitia, adipisci dignissimos repellendus. Corrupti praesentium deleniti harum non quaerat fugiat odio! Est
        veritatis assumenda doloremque ex rem labore. Dolor magnam inventore est eos aliquam.
      </p>
    </section>
  );
};
